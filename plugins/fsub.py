...
async def force_sub(c, m):
    if Config.FORCE_SUB:
        try:
            ...
            button = [[InlineKeyboardButton('join Updates channel', url=f'https://t.me/team_lad')]]
            ...
            logger.warning(f"Make me admin in @Team_lad")
            if m.from_user.id in Config.AUTH_USERS:
                return await m.reply_text(f"Make me admin in @Team_Lad")
